...
WORDLIST_FILENAME = "D:/Workbench/Online Courses/6.00.1x/Problem Set 6/words.txt"
...
def getStoryString():
    ...
    """
    return open("D:/Workbench/Online Courses/6.00.1x/Problem Set 6/story.txt", "r").read()
