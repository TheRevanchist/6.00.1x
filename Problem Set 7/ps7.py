...
class NewsStory(object):
    def __init__(self, guid, myTitle, mySubject, mySummary, link):
        ''' creates the object '''
        self.guid = guid
    ...
    ''' A few getter methods which let you get the information for the object '''
    def getGuid(self):
         return self.guid 
...
def filterStories(stories, triggerlist):
    ...
    for element in stories:
        for trigger in triggerlist:
            if trigger.evaluate(element) and element not in lista:
